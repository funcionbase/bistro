 ...
 * llenar. El staff decide cuándo con el botón "Actualizar". La recarga
 * silenciosa con pestaña oculta sigue viviendo en spa/main.tsx.
 */
export function PwaUpdateBanner() {
    ...
    return (
        <div className="border-border bg-card text-card-foreground fixed inset-x-0 bottom-0 z-50 mx-auto flex max-w-md items-center justify-between gap-3 rounded-t-2xl border border-b-0 px-4 py-3 shadow-lg">
