...
return new class extends Migration
{
    ...
    private const OLD_DESCRIPTION = 'Acceso completo a la plataforma bistro. $100.000 COP/mes (IVA 19% incluido).';

    private const NEW_DESCRIPTION = 'Acceso completo a la plataforma bistro. $300.000 COP/mes (IVA 19% incluido).';
