...
return [
    ...
    */
    ...
    'available_banks' => env('AVAILABLE_BANKS', 'Bancolombia,Davivienda,BBVA,Nequi'),

    'enforce_gsuite_domain' => (bool) env('ENFORCE_GSUITE_DOMAIN', false),

    'oauth_rate_limit' => (int) env('OAUTH_RATE_LIMIT', 10),

    'jwt_blacklist_enabled' => (bool) env('JWT_BLACKLIST_ENABLED', false),
