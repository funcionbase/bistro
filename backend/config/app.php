...
return [
    ...
    */
    ...
    |
    | Cutover #239: el subdominio operativo es `panel.flexyflow.co` en pdn y
    ...
    */
    ...
    // Default America/Bogota: la app es operativa en Colombia (todas las
    // empresas en CO). UTC era un default peligroso — si alguien removía
    // APP_TIMEZONE del .env, los filtros "del día" rotaban a las 19:00 local.
    ...
    */
    ...
    'security_headers_enabled' => (bool) env('SECURITY_HEADERS_ENABLED', false),
