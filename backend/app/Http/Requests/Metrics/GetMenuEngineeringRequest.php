...
/**
 * Endpoint: GET /api/v1/metrics/menu-engineering (MenuEngineeringController). Requiere reports.read.
 *
 * Períodos: today, week, month, custom. Default = month (mediana estable). limit opcional 1..200.
 */
class GetMenuEngineeringRequest extends FormRequest
{
