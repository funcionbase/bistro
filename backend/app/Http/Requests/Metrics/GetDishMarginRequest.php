...
/**
 * Endpoint: GET /api/v1/metrics/dishes/margin (MetricsController). Requiere reports.read.
 *
 * Períodos: today, week, month, custom. limit opcional (1..50).
 */
class GetDishMarginRequest extends FormRequest
{
