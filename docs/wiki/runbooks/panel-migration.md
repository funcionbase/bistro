...
# Dentro:
cat /var/www/panel.flexyflow/bistro/backend/.env | grep -E 'APP_URL|SESSION_DOMAIN|GOOGLE_REDIRECT_URI'
...
aws ssm start-session --target i-XXXXX --region us-east-1
# Luego dentro: tail -f /var/www/panel.flexyflow/bistro/backend/storage/logs/laravel.log
