...
| `MAIL_FROM_ADDRESS` | Sí | `hello@funcionbase.com` | Debe pertenecer al dominio verificado en SES |
| `MAIL_FROM_NAME` | Sí | `${APP_NAME}` | Nombre mostrado al destinatario |
| `MAIL_REPLY_TO_ADDRESS` | No | `hello@funcionbase.com` | Buzón que recibe respuestas vía CF Email Routing |
...
| `BILLING_OPS_EMAIL` | No | `hello@funcionbase.com` | Email operativo para notificación de comprobantes subidos (#175) |
